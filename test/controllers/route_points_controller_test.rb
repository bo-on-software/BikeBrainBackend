...
class RoutePointsControllerTest < ActionController::TestCase
  ...
  test "should create route_point" do
    assert_difference('RoutePoint.count') do
      post :create, route_point: { cadence: @route_point.cadence, gps_latitude: @route_point.gps_latitude, gps_longitude: @route_point.gps_longitude, gps_speed: @route_point.gps_speed, gps_time: @route_point.gps_time, trip_id: @route_point.trip_id }
    end
  ...
  test "should update route_point" do
    patch :update, id: @route_point, route_point: { cadence: @route_point.cadence, gps_latitude: @route_point.gps_latitude, gps_longitude: @route_point.gps_longitude, gps_speed: @route_point.gps_speed, gps_time: @route_point.gps_time, trip_id: @route_point.trip_id }
    assert_redirected_to route_point_path(assigns(:route_point))
  end
